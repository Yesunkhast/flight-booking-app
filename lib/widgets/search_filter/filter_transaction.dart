...
class _FilterTransactionState extends State<FilterTransaction>
  ...
  final RestorableDateTimeN _endDate =
      RestorableDateTimeN(DateTime(2025, 1, 5));
  ...
  Widget build(BuildContext context) {
    ButtonStyle buttonStyle =
        ThemeButton.btnSmall.merge(ThemeButton.outlinedDefault(context));
          ...
          child: ListView(scrollDirection: Axis.horizontal, children: [
            ...
            OutlinedButton(
                ...
                child: Row(children: [
                  Icon(Icons.swap_vert,
                      size: 16, color: ThemePalette.primaryMain),
                  const SizedBox(width: 2),
                  Text('Sort By ${sortbyTemp.toCapitalCase()}',
                      style: ThemeText.caption),
                  const SizedBox(width: 2),
                  Icon(Icons.arrow_drop_down,
                      color: colorScheme(context).onSurface, size: 16),
            ...
            OutlinedButton(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 2),
                  Text(
                      '${DateFormat.MMMd().format(_startDate.value!)} - ${DateFormat.MMMd().format(_endDate.value!)}',
                      style: ThemeText.caption),
                  const SizedBox(width: 2),
                  Icon(Icons.arrow_drop_down,
                      color: colorScheme(context).onSurface, size: 16),
