...
class _WalletListState extends State<WalletList> {
  final List _banks = <GeneralList>[
    GeneralList(
        ...
        text: 'Wallet A',
        desc: '\$20',
        thumb: 'assets/images/logos/logo9.jpg'),
    GeneralList(
        value: 'wallet2',
        text: 'Wallet B',
        thumb: 'assets/images/logos/logo10.jpg'),
    GeneralList(
        value: 'wallet3',
        text: 'Wallet C',
        thumb: 'assets/images/logos/logo11.jpg'),
    GeneralList(
        value: 'wallet4',
        text: 'Wallet D',
        desc: '\$5',
        thumb: 'assets/images/logos/logo12.png'),
    GeneralList(
        value: 'wallet5',
        text: 'Wallet E',
        thumb: 'assets/images/logos/logo13.png'),
    GeneralList(
        value: 'wallet6',
        text: 'Wallet F',
        desc: '\$12',
        thumb: 'assets/images/logos/logo14.jpg'),
  ];
    ...
    return ListView.builder(
      ...
      itemBuilder: ((BuildContext context, int index) {
        ...
        return ListTile(
            ...
            subtitle:
                Text(item.desc ?? 'Not Connected', style: ThemeText.paragraph),
