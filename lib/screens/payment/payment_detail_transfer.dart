      ...
      body: Center(
        child: ConstrainedBox(
          ...
          child: Column(children: [
                ...
                children: [
                  PaperCard(
                    content: Padding(
                      padding: EdgeInsets.all(spacingUnit(2)),
                      child: Column(children: [
                        Text('\$630.00', style: ThemeText.title.copyWith(color: ThemePalette.primaryMain, fontWeight: FontWeight.bold)),
            ...
            /// ACTION BUTTON
            Container(
              color: Get.isDarkMode ? colorScheme(context).surface : colorScheme(context).surfaceContainerHighest,
