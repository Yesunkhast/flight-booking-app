            ...
            Expanded(
              child: ListView(children: [
                const ListTile(
                  ...
                  trailing: Text('\$630.00', style: ThemeText.paragraph,),
                ),
                const LineList(),
                const ListTile(
                  leading: Icon(Icons.info_outline),
                  title: Text('Tax 12%:'),
                  trailing: Text('\$75.6', style: ThemeText.paragraph,),
                ),
                const LineList(),
                ListTile(
                  title: Text('Total:', style: ThemeText.title2.copyWith(fontWeight: FontWeight.bold),),
                  trailing: Text('\$705.6', style: ThemeText.title2.copyWith(fontWeight: FontWeight.bold, color: ThemePalette.primaryMain),),
                ),
              ])
            ),
            Container(
